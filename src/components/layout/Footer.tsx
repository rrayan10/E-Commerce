        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-block">
              <span className="font-display text-2xl tracking-tight">ShopMart</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground max-w-xs">
              Curated fashion essentials for the modern wardrobe. Timeless pieces crafted with intention.
            </p>
          ...
          <div>
            <h3 className="text-sm font-semibold tracking-wide uppercase">Help</h3>
            <ul className="mt-4 space-y-3">
